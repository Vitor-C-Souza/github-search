...
class RepositoryAdapter(private val repositories: List<Repository>, private var activity: MainActivity) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.btnShare.setOnClickListener {
            activity.shareRepositoryLink(repository.htmlUrl)
        }

        holder.nomeRepositorio.setOnClickListener {
            activity.openBrowser(repository.htmlUrl)
        }
    }
